...
class Eject(Command):
    ...
    def __init__(self, fuel_system: FuelSubsystem):
        ...
        # Declare the instance of fuel_system as a dependency
    ...
    def initialize(self):
        ...
        """
        self.fuel_system.set_intake_launcher_roller(-1 * SmartDashboard.getNumber("Intaking intake roller value", INTAKING_INTAKE_VOLTAGE))
        self.fuel_system.set_feeder_roller(-1 * SmartDashboard.getNumber("Intaking feeder roller value", INTAKING_FEEDER_VOLTAGE))
